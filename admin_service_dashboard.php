...
elseif($msg=="fail"){
    ...
    ?>
        ...
        <div class="innerdiv">
            ...
            <div><label>Branch:</label><input type="radio" name="branch" value="other"/>Other<input type="radio" name="branch" value="BCA"/>BCA<div style="margin-left:80px"><input type="radio" name="branch" value="MCA"/>MCA<input type="radio" name="branch" value="COMADY"/>COMADY</div>
            </div>   
